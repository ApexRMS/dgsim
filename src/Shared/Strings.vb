...
Module Strings
    ...
    'Stratum data sheet
    Public Const STRATUM_DATASHEET_NAME As String = "dgsim__Stratum"

    'Age Class data sheet
    Public Const AGE_CLASS_DATASHEET_NAME As String = "dgsim__AgeClass"

    'Run Control data sheet
    Public Const RUN_CONTROL_DATASHEET_NAME As String = "dgsim__RunControl"
    ...
    Public Const INITIAL_POPULATION_SIZE_DATASHEET_NAME As String = "dgsim__InitialPopulationSize"

    'Initial population distribution data sheet
    Public Const INITIAL_POPULATION_DISTRIBUTION_DATASHEET_NAME As String = "dgsim__InitialPopulationDistribution"
    Public Const INITIAL_POPULATION_DISTRIBUTION_DATASHEET_RELATIVE_AMOUNT_COLUMN_NAME As String = "RelativeAmount"

    'Census data sheet
    Public Const CENSUS_DATASHEET_NAME As String = "dgsim__Census"
    ...
    Public Const AGE_CLASS_RANGE_DATASHEET_NAME As String = "dgsim__AgeClassRange"

    'Offspring Per Female data feed
    Public Const OFFSPRING_PER_FEMALE_OPTION_DATASHEET_NAME As String = "dgsim__OffspringPerFemaleOption"
    Public Const OFFSPRING_PER_FEMALE_VALUE_DATASHEET_NAME As String = "dgsim__OffspringPerFemaleValue"
    ...
    Public Const ANNUALIZED_MORTALITY_RATE_DATASHEET_NAME As String = "dgsim__AnnualizedMortalityRate"

    'Annual harvest data feed
    Public Const ANNUAL_HARVEST_OPTION_DATASHEET_NAME As String = "dgsim__AnnualHarvestOption"
    Public Const ANNUAL_HARVEST_VALUE_DATASHEET_NAME As String = "dgsim__AnnualHarvestValue"
    ...
    Public Const DEMOGRAPHIC_RATE_SHIFT_DATASHEET_NAME As String = "dgsim__DemographicRateShift"
    ...
    Public Const OUTPUT_POPULATION_SIZE_DATASHEET_NAME As String = "dgsim__OutputPopulationSize"
    Public Const OUTPUT_POPULATION_SIZE_POPULATION_COLUMN_NAME As String = "Population"

    'Output harvest data sheet
    Public Const OUTPUT_HARVEST_DATASHEET_NAME As String = "dgsim__OutputHarvest"
    Public Const OUTPUT_HARVEST_HARVEST_COLUMN_NAME As String = "Harvest"

    'Output recruits data sheet
    Public Const OUTPUT_RECRUITS_DATASHEET_NAME As String = "dgsim__OutputRecruits"
    ...
    Public Const OUTPUT_MORTALITY_DATASHEET_NAME As String = "dgsim__OutputMortality"
    Public Const OUTPUT_MORTALITY_MORTALITY_COLUMN_NAME As String = "Mortality"

    'Output Posterior Distribution Values Data Sheet
    Public Const OUTPUT_POSTERIOR_DIST_VALUE_DATASHEET_NAME As String = "dgsim__OutputPosteriorDistributionValue"
